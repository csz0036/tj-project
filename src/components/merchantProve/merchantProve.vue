  ...
  <div id="merchantProve">
    <form class="mui-input-group">
        <div class="mui-input-row">
            <label>老板姓名</label>
            <input type="text" v-model="form.bossName" class="mui-input-clear" placeholder="请输入用户名">
        </div>
        ...
        <div class="mui-input-row">
            <label>联系电话</label>
            <input type="text" v-model="form.telephone" class="mui-input-clear" placeholder="买家咨询设备时将拨打该号码">
        </div>
        <div class="mui-input-row">
            <label>注册手机号</label>
        ...
        <div class="mui-input-row">
            <label>主营</label>
            <input type="text" v-model="form.mainCamp" class="mui-input-clear" placeholder="请输入">
        </div>
    </form>
    ...
    <div class="picList">
      ...
      <div class="picLi" v-for="item in upImg">
        <div class="showPic">
          <div class="img_p">
            <!-- 图片上传 -->
    ...
    <p class="butStyle_1 but" @click="subProve">提交认证</p>
...
export default {
  data () {
    return {
      ...
      upImg: [
        {id: 1, upinfo: '老板手持身份证照片', tit: '老板头像'},
        {id: 2, upinfo: '区域负责人约老板档口合影', tit: '场地认证'},
        {id: 3, upinfo: '区域负责人约老板档口合影', tit: '合影认证'},
        {id: 4, upinfo: '老板手持身份证照片', tit: '身份认证'},
        {id: 5, upinfo: '老板法人执照', tit: '营业执照'}
      ],
      provincesBoo: false,
      provincesName: '',
      provincesId: '',
  ...
  methods: {
    ...
    subProve () {
      ...
      req.get('/shopCtrl/v1/addInformation', {
        sessionKey: localStorage.getItem('sessionKey'),
        ...
        mainCamp: this.form.mainCamp || '', // 主营
        image1: img1 || '', // 老板头像
        image2: img2 || '', // 场地
        image3: img3 || '', // 合影认证
        image4: img4 || '', // 身份证认证
